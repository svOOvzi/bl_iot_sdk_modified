//  NimBLE Porting Layer. Based on https://github.com/apache/mynewt-nimble/blob/master/porting/npl/freertos/include/nimble/nimble_npl_os.h
/*
...
{
    taskEXIT_CRITICAL();  ////  Previously vPortExitCritical();
